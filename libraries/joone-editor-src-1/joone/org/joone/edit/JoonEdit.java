...
public class JoonEdit extends DrawApplication {
    ...
    private static final int RECO_ENG_BUILD = 1;
    /**
    ...
    // Max number of tools x palette
    private final int MAX_TOOLS = 20;
    ...
    private void initJoonEdit(InputStream isParams) {
        ...
        setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE); // Close handled by Joone.
        readIniFile();
    }
