...
public class AboutFrame extends JDialog
{
    ...
    private static final String [] HALL_OF_FAME = {
        ...
        "   Ka-Hing Cheung, Andrea Corti, Firestrand, Jan Erik Garshol,",
        "   Harry Glasgow, Jack Hawkins, Nathan Hindley, Olivier Hussenet,",
        "   Boris Jansen, Shen Linlin, Casey Marshall, Julien Norman,",
        "   Christian Ribeaud, Anat Rozenzon, Trevis Silvers, Paul Sinclair,",
        "   Thomas Lionel Smets, Jerry R.Vos"
    };
